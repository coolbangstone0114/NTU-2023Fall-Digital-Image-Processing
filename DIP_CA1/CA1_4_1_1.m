...
fs_input_points = load("./data-points/fs_input_points.mat");
fs_base_points = load("./data-points/fs_base_points.mat");
fsr_input_points = load("./data-points/fsr_input_points.mat");
fsr_base_points = load("./data-points/fsr_base_points.mat");
fss_input_points = load("./data-points/fss_input_points.mat");
fss_base_points = load("./data-points/fss_base_points.mat");
